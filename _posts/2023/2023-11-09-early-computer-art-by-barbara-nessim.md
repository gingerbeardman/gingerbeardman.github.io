...
They were drawn using a Norpak IPS2 Videotex (NAPLPS/Telidon) system, running on a PDP-11/03. This offered 6 drawing modes (arc, rectangle, circle, line, dot and polygon) and 12 colours plus black and white. That equates to a computer system roughly equivalent to an Apple II running a rudimentary graphics application, in fact you could get an add-on card for the Apple II to give it full [Norpak Telidon capabilities](https://wiki.preterhuman.net/Norpak_Telidon_Graphics_System). The main benefit of the Norpak IPS2 computer system was that it had pen/stylus input.
