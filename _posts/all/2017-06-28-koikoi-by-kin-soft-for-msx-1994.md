...
After some thought I figured out that using the Windows tool dsk2rom.exe I could convert the .dsk into an MSX .rom file that would boot up straight into the game in fMSX. 
