...
- Minotaur Project
redirect_from:
- /2021/03/08/two-old-llamasoft-iphone-and-ipad-games/
...
Back in 2017 a large number of games and apps were rendered obsolete when iOS 11 removed 32-bit compatibility: the appocalypse. At that time I was still downloading apps into iTunes as backups, and seem to have put aside some of these great Llamasoft games—Gridrunner and Minotron: 2112. What foresight!

Since then, with the help of others, I've tracked down the rest, and we now have all nine games of the [Minotaur Project](http://minotaurproject.co.uk/Minotaur/fiveaday.php) — Jeff Minter and Ivan Zorzin's run of iOS games — preserved and available.
...
Edit, 2021-09-13: I've added a decrypted version of Minotron: 2112 that should be easier to install on a jailbroken device. 
