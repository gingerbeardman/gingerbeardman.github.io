...
![IMG](/images/posts/abandoned-playdate-band-kun.png)
...
- as a solo endeavour as I was confident I could do the new scope myself
- [pitch pdf](https://cdn.gingerbeardman.com/files/playdate-pitch-2024-beatnik.pdf)

![IMG](/images/posts/abandoned-playdate-beatnik.png)
...
In August 2024, to test and prove some of the technology and concepts, I used some of the tooling and library code I had created for certain features in my Playdate game [Bender 2: Bend Harder](/2024/10/08/bender-2-bend-harder-for-playdate/), and expanded version of an original concept web game I had created back in 2012, which I created in two weeks on break from work on Beatnik. [And that was that](/2025/04/15/when-playdate-stopped-being-fun/).
