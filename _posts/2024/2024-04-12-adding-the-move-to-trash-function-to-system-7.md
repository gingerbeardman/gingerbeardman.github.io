...
1. install [AppleScript 1.1](https://macintoshgarden.org/apps/applescript-11) (specifically the *Finder Scripting Software* option, which installs both Scriptable Finder 7.1.3 and Finder Scripting Extension)
