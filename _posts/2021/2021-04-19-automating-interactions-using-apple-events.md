...
![PNG](https://cdn.gingerbeardman.com/images/posts/automating-apple-events.png#pixel "Example of a KeyQuencer Macro that works in both artWORKS and UltraPaint")
{:.tofigure}
